      ...
      >
        <div className="hidden sm:flex flex-col items-center justify-center text-[#464646] dark:text-white font-bold text-[32px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="117" height="121" viewBox="0 0 117 121" fill="none">
            ...
            <path d="M31.8157 49.8039L36.6668 42.7969L58.6207 54.0875L52.3815 61.4611C51.9969 61.9156 51.3458 62.0372 50.8231 61.7521L32.2465 51.6194C31.592 51.2624 31.3914 50.4169 31.8157 49.8039Z" fill="#DCDBDC" stroke="#464646" stroke-width="1.72952" stroke-linecap="round" />
            <path d="M64.2481 61.3355L58.6211 54.0205L81.2023 43.9844L85.3695 49.7144C85.8186 50.3318 85.6167 51.2038 84.9419 51.561L65.8294 61.6794C65.2889 61.9655 64.6209 61.8202 64.2481 61.3355Z" fill="#DCDBDC" stroke="#464646" stroke-width="1.72952" stroke-linecap="round" />
            <path d="M36.0373 67.0488L35.9941 53.6016L51.2674 61.6625C51.44 61.7535 51.6522 61.7177 51.7854 61.5751L57.9208 55.0003C58.1713 54.732 58.6209 54.9092 58.6209 55.2763V78.097C58.6209 78.5633 58.1302 78.8666 57.7131 78.6581L36.7307 68.1669C36.307 67.955 36.0388 67.5225 36.0373 67.0488Z" fill="#0088FF" stroke="#464646" stroke-width="1.72952" stroke-linecap="round" />
            <path d="M80.5088 68.1681L59.2468 78.7991C58.9593 78.9428 58.6211 78.7338 58.6211 78.4124V55.6293C58.6211 55.2285 59.119 55.0434 59.3808 55.3468L64.7428 61.5608C64.8725 61.7112 65.0881 61.7538 65.2653 61.6642L81.2023 53.6016V67.046C81.2023 67.5212 80.9338 67.9556 80.5088 68.1681Z" fill="#0088FF" stroke="#464646" stroke-width="1.72952" stroke-linecap="round" />
            <path d="M80.9623 43.6633L58.4785 34.3672" stroke="#464646" stroke-width="1.72952" stroke-linecap="round" />
            <path d="M36.8595 42.3662L58.4785 34.3672" stroke="#464646" stroke-width="1.72952" stroke-linecap="round" />
            <path d="M78.1512 65.4442V63.8168C78.1512 63.4954 77.8129 63.2863 77.5254 63.4301L74.4988 64.9434C74.3523 65.0166 74.2598 65.1663 74.2598 65.3301V66.9576C74.2598 67.279 74.598 67.488 74.8855 67.3443L77.9122 65.831C78.0587 65.7577 78.1512 65.608 78.1512 65.4442Z" stroke="#464646" stroke-width="0.864759" stroke-linecap="round" />
            <path d="M58.6953 53.1729V35.4453L79.0171 43.8767L58.6953 53.1729Z" fill="#898989" stroke="#464646" stroke-width="0.432379" stroke-linecap="round" />
            <path d="M58.2617 53.1729V35.4453L38.3723 42.7958L58.2617 53.1729Z" fill="#D9D9D9" stroke="#464646" stroke-width="0.432379" stroke-linecap="round" />
          </svg>
          SKLAD-MARKET
        </div>
        <div className="sm:hidden flex flex-col items-center justify-center text-[#464646] dark:text-white font-bold text-[18px]">
          <svg xmlns="http://www.w3.org/2000/svg" width="68" height="70" viewBox="0 0 68 70" fill="none">
            ...
            <path d="M18.3527 28.7296L21.1511 24.6875L33.8154 31.2006L30.2162 35.4541C29.9944 35.7163 29.6188 35.7864 29.3173 35.622L18.6012 29.7768C18.2236 29.5709 18.1079 29.0832 18.3527 28.7296Z" fill="#DCDBDC" stroke="#464646" stroke-width="0.997688" stroke-linecap="round" />
            <path d="M37.0624 35.3842L33.8164 31.1644L46.8426 25.375L49.2465 28.6804C49.5055 29.0366 49.389 29.5396 48.9998 29.7456L37.9746 35.5825C37.6628 35.7476 37.2775 35.6638 37.0624 35.3842Z" fill="#DCDBDC" stroke="#464646" stroke-width="0.997688" stroke-linecap="round" />
            <path d="M20.7905 38.679L20.7656 30.9219L29.5762 35.5719C29.6757 35.6244 29.7981 35.6038 29.8749 35.5215L33.4142 31.7288C33.5587 31.574 33.8181 31.6762 33.8181 31.8879V45.0523C33.8181 45.3213 33.535 45.4962 33.2944 45.3759L21.1905 39.324C20.9461 39.2018 20.7914 38.9523 20.7905 38.679Z" fill="#0088FF" stroke="#464646" stroke-width="0.997688" stroke-linecap="round" />
            <path d="M46.4425 39.3247L34.1774 45.4573C34.0115 45.5402 33.8164 45.4196 33.8164 45.2342V32.0916C33.8164 31.8604 34.1037 31.7536 34.2547 31.9286L37.3478 35.5132C37.4226 35.6 37.5469 35.6246 37.6492 35.5729L46.8426 30.9219V38.6774C46.8426 38.9516 46.6877 39.2021 46.4425 39.3247Z" fill="#0088FF" stroke="#464646" stroke-width="0.997688" stroke-linecap="round" />
            <path d="M46.7043 25.1907L33.7344 19.8281" stroke="#464646" stroke-width="0.997688" stroke-linecap="round" />
            <path d="M21.2633 24.4424L33.7344 19.8281" stroke="#464646" stroke-width="0.997688" stroke-linecap="round" />
            <path d="M45.0846 37.7486V36.8098C45.0846 36.6244 44.8895 36.5038 44.7237 36.5867L42.9777 37.4597C42.8932 37.502 42.8398 37.5883 42.8398 37.6828V38.6216C42.8398 38.807 43.035 38.9276 43.2008 38.8447L44.9468 37.9717C45.0313 37.9295 45.0846 37.8431 45.0846 37.7486Z" stroke="#464646" stroke-width="0.498844" stroke-linecap="round" />
            <path d="M33.8594 30.6716V20.4453L45.5822 25.309L33.8594 30.6716Z" fill="#898989" stroke="#464646" stroke-width="0.249422" stroke-linecap="round" />
            <path d="M33.6094 30.6716V20.4453L22.136 24.6855L33.6094 30.6716Z" fill="#D9D9D9" stroke="#464646" stroke-width="0.249422" stroke-linecap="round" />
          </svg>
          SKLAD-MARKET
        </div>
      </motion.div>
