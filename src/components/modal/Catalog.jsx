            ...
            <div className="flex items-center justify-between px-5 h-16 border-b border-ink-100 dark:border-[#1C1C1C] shrink-0">
              {mobileParent ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="138" height="26" viewBox="0 0 138 26" fill="none" className="text-black dark:text-white">
                  ...
                  <path d="M6.69449 10.4746L7.71538 9L12.3355 11.3761L11.0225 12.9278C10.9416 13.0235 10.8045 13.0491 10.6945 12.9891L6.78514 10.8567C6.64741 10.7815 6.60519 10.6036 6.69449 10.4746Z" fill="#DCDBDC" stroke="#464646" stroke-width="0.363972" stroke-linecap="round" />
                  <path d="M13.5201 12.9015L12.3359 11.3621L17.0881 9.25L17.9651 10.4559C18.0596 10.5858 18.0171 10.7693 17.8751 10.8445L13.8529 12.9739C13.7392 13.0341 13.5986 13.0035 13.5201 12.9015Z" fill="#DCDBDC" stroke="#464646" stroke-width="0.363972" stroke-linecap="round" />
                  <path d="M7.58329 14.1034L7.57422 11.2734L10.7884 12.9698C10.8248 12.989 10.8694 12.9815 10.8974 12.9514L12.1886 11.5678C12.2413 11.5113 12.336 11.5486 12.336 11.6259V16.4284C12.336 16.5266 12.2327 16.5904 12.1449 16.5465L7.72923 14.3387C7.64006 14.2941 7.58361 14.2031 7.58329 14.1034Z" fill="#0088FF" stroke="#464646" stroke-width="0.363972" stroke-linecap="round" />
                  <path d="M16.9421 14.3389L12.4676 16.5762C12.4071 16.6064 12.3359 16.5624 12.3359 16.4948V11.7002C12.3359 11.6158 12.4407 11.5769 12.4958 11.6407L13.6242 12.9484C13.6515 12.9801 13.6969 12.9891 13.7342 12.9702L17.0881 11.2734V14.1028C17.0881 14.2028 17.0316 14.2942 16.9421 14.3389Z" fill="#0088FF" stroke="#464646" stroke-width="0.363972" stroke-linecap="round" />
                  <path d="M17.0363 9.18291L12.3047 7.22656" stroke="#464646" stroke-width="0.363972" stroke-linecap="round" />
                  <path d="M7.75503 8.90994L12.3047 7.22656" stroke="#464646" stroke-width="0.363972" stroke-linecap="round" />
                  <path d="M16.4439 13.771V13.4285C16.4439 13.3608 16.3728 13.3168 16.3123 13.3471L15.6753 13.6656C15.6445 13.681 15.625 13.7125 15.625 13.747V14.0894C15.625 14.1571 15.6962 14.2011 15.7567 14.1708L16.3936 13.8524C16.4245 13.8369 16.4439 13.8054 16.4439 13.771Z" stroke="#464646" stroke-width="0.181986" stroke-linecap="round" />
                  <path d="M12.3516 11.1838V7.45312L16.6282 9.22749L12.3516 11.1838Z" fill="#898989" stroke="#464646" stroke-width="0.0909931" stroke-linecap="round" />
                  <path d="M12.2617 11.1838V7.45312L8.07604 9.00001L12.2617 11.1838Z" fill="#D9D9D9" stroke="#464646" stroke-width="0.0909931" stroke-linecap="round" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M102.016 4.1505C108.555 4.13355 118.306 2.59782 118.554 11.9503C118.638 15.1274 118.461 16.9259 116.206 19.3204C112.889 22.2006 106.458 21.4421 102 21.4161L102.016 4.1505ZM105.821 7.19347L105.813 18.3566C108.624 18.4016 111.191 18.8444 113.394 17.0597C115.098 14.738 115.364 10.1025 112.92 8.18663C111.296 6.91394 107.848 7.18167 105.821 7.19347Z" fill="currentColor" />
